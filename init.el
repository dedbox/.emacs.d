...
(use-package racket-mode
  ...
  :config (progn
            ...
            (put 'semiwith-template 'racket-indent-function 1)
            (put 'semiquote-template 'racket-indent-function 1)
            (put 'quote-template 'racket-indent-function 1)
            (put 'templates 'racket-indent-function 0)
            (put 'template 'racket-indent-function 1)
            (put 'semitemplate 'racket-indent-function 1)
            (put 'quoted-template 'racket-indent-function 1)
            (put 'semiquoted-template 'racket-indent-function 1)
            (put 'begin-template 'racket-indent-function 0)
            (put 'begin0-template 'racket-indent-function 1)
            (put 'let-template 'racket-indent-function 1)
            (put 'letrec-template 'racket-indent-function 1)
            (put 'splicing-let-template 'racket-indent-function 1)
            (put 'splicing-letrec-template 'racket-indent-function 1)
            (put 'if-template 'racket-indent-function 1)
            (put 'cond-template 'racket-indent-function 0)
            (put 'when-template 'racket-indent-function 1)
            (put 'unless-template 'racket-indent-function 1)
            (put 'for/? 'racket-indent-function 'racket--indent-for)
            (put 'for*/? 'racket-indent-function 'racket--indent-for)
            (put 'for/template 'racket-indent-function 'racket--indent-for)
            (put 'for*/template 'racket-indent-function 'racket--indent-for)))
