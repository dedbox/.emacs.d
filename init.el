...
(use-package racket-mode
  ...
  :config (progn
            ...
            (put 'for/mat 'racket-indent-function 1)
            (put 'for*/mat 'racket-indent-function 1)
            (put 'for/mat-columns 'racket-indent-function 1)
            (put 'for*/mat-columns 'racket-indent-function 1)
            (put 'for/vec 'racket-indent-function 1)
            (put 'for*/vec 'racket-indent-function 1)
            (put 'test-suite 'racket-indent-function 1)
            (put 'with-template 'racket-indent-function 1)
